...
CONFIG = {
    ...
    "output_file": "clustering_v4.json",
    # 断点
    ...
    "checkpoint_file": "checkpoint_clustering_v4.json",
...
def main():
    global CONFIG
    CONFIG = apply_layout_to_config_05(dict(CONFIG), BASE_DIR, "v4")
    ...
    if not os.path.exists(CONFIG["predictions_path"]):
        raise FileNotFoundError(
            ...
            "Please run 02_inference_auto_v4.py first."
        )
