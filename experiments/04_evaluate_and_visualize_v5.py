...
评测说明：IoU 匹配阈值见 EVAL_DETECTION_IOU_THRESHOLD（正文约 p.4），与 Eq.(9) β 无关。
"""
...
CONFIG = {
    ...
    'version': 'V5',
    'alignment_notes': 'Paper-aligned method with local enhanced-eval dataset: fb_source=augmented_intact, eval=augmented_intact + augmented anomalies, feature f=[W_out,b]',
}
...
if __name__ == "__main__":
    CONFIG = apply_layout_to_config_04(dict(CONFIG), BASE_DIR, "v5")
