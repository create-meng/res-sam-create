...
CONFIG = {
    ...
    "vis_output_dir": os.path.join(BASE_DIR, "outputs", "visualizations_v11"),
    "analysis_output": os.path.join(BASE_DIR, "outputs", "visualizations_v11", "03_evaluate_and_visualize_v11_report.md"),
    "paper_reference": {
    ...
    "version": "v11",
    "alignment_notes": (
        "Paper-first mainline (v11): Eq.(3)/(8) uses f=[W_out,b]; "
...
def plot_region_auc_curve(results: dict, output_path: str) -> float | None:
    ...
    plt.title("Res-SAM v11 Region-level ROC")
...
def main() -> None:
    ...
    if os.path.exists(CONFIG["predictions_path"]):
        ...
        region_auc = plot_region_auc_curve(results, os.path.join(CONFIG["vis_output_dir"], "region_roc_curve_v11.png"))
...
if __name__ == "__main__":
    CONFIG = apply_layout_to_config_04(dict(CONFIG), BASE_DIR, "v11")
