"""
Res-SAM v10 - Step 1: build the feature bank.

Current v10 mainline policy:
...
For preprocessing, v10 uses a fixed resize to 369x369 for all images,
matching the default loading convention in the official repository.
The v10 runtime seed is unified to 11.
"""
...
CONFIG = {
    ...
    "output_dir": os.path.join(BASE_DIR, "outputs", "feature_banks_v10"),
    "output_file": "feature_bank_v10.pth",
    ...
    "alignment_notes": "Paper-first mainline (v10): solve true f=[W_out,b]; fb_source=augmented_intact, eval=augmented_*",
}
...
def build_feature_bank(config: dict, resume: bool = True):
    ...
    print("=" * 60)
    print("Res-SAM v10：Feature Bank 构建")
    print("=" * 60)
    ...
    all_metadata = {
        ...
        "preprocess_signature": {
            ...
            "resize": {
                ...
                "note": "v10 mainline uses fixed resize; all images are resized to image_size to match the official 369x369 default.",
            },
    ...
    print(f"\nFeature Bank v10 保存至: {output_path}")
...
if __name__ == "__main__":
    ...
    # 复用当前唯一数据布局，并固定输出到 v10 Feature Bank 目录。
    CONFIG = apply_layout_to_config_01(dict(CONFIG), BASE_DIR, "v10")
    CONFIG["version"] = "v10"
    CONFIG["output_dir"] = os.path.join(BASE_DIR, "outputs", "feature_banks_v10")
    CONFIG["output_file"] = "feature_bank_v10.pth"
