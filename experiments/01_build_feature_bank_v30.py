...
CONFIG = {
    ...
    "output_dir": os.path.join(BASE_DIR, "outputs", "feature_banks_v30"),
    "output_file": "feature_bank_v30.pth",
...
if __name__ == "__main__":
    ...
    if bank_suffix:
        CONFIG["output_dir"] = os.path.join(BASE_DIR, "outputs", f"feature_banks_v30{bank_suffix}")
        CONFIG["output_file"] = f"feature_bank_v30{bank_suffix}.pth"
    else:
        CONFIG["output_dir"] = os.path.join(BASE_DIR, "outputs", "feature_banks_v30")
        CONFIG["output_file"] = "feature_bank_v30.pth"
